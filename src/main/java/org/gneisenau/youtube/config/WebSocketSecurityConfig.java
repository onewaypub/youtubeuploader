...
//
// @Override
// public final void configureClientInboundChannel(ChannelRegistration
// registration) {
...
// */
// protected void customizeClientInboundChannel(ChannelRegistration
// registration) {
// }
//
// @Bean
...
// }
//
// List<AccessDecisionVoter<? extends Object>> voters = new
// ArrayList<AccessDecisionVoter<? extends Object>>();
// voters.add(voter);
//
...
// public void
// setMessageExpessionHandler(List<SecurityExpressionHandler<Message<Object>>>
// expressionHandlers) {
...
// }
//
// TransportHandlingSockJsService transportHandlingSockJsService =
...
// List<HandshakeInterceptor> interceptorsToSet = new
// ArrayList<HandshakeInterceptor>(
...
// + " is expected to contain mappings to either a SockJsHttpRequestHandler or a
// WebSocketHttpRequestHandler but got "
// + object);
// }
// }
//
// if (inboundRegistry.containsMapping() &&
// !inboundRegistry.isSimpDestPathMatcherConfigured()) {
